...
map::map(QGraphicsView *v)
{
   ...
   QVector<QPoint> list;
 list<< QPoint(0,1024)      << QPoint(36000,1024)   << QPoint(24800,860)
     << QPoint(24700,880)   << QPoint(24400,900)    << QPoint(24300,900)
     << QPoint(24150,870)   << QPoint(24000,885)    << QPoint(23900,880)
   ...
   //Set Brush
   setBrush(QBrush(QColor(Qt::transparent)));
   hide();
   //check Collision
   view = v;
}
