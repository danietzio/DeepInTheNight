...
bool mark_ctrl_enemy;
bool health_player_decrease;
enemy::enemy(QGraphicsScene *_Scene)
{
    setPos(2730,650);
...
//    }
    if(!li.empty()) {
        collied_with_player = true;
        return true;
    }
    else {
        collied_with_player = false;
        return false;
    }
}
...
void enemy::checkHealth()
{
    ...
    if(collied_with_player == true && mark_ctrl == true && mark_ctrl_player == false) {
            health_player_decrease = true;
    }
    else health_player_decrease = false;
    if(health_enemy_decrease == true)Health->set_Health(20);

}

void enemy::move()
{
    getPlayerCoordinate(x_player,y_player);
    static int counter1 = 0;
    counter1++;
    if(x_pl > 1500 - 2370 + x()  && x_pl < 3500 - 2370 + x() && x_player != -1 && y_player != -1) {
        if(calculateDistance() > 1100 && calculateDistance()  < 1400)
        {
            ...
            qDebug() << x() << x_pl << y_pl << y()  << calculateDistance() << direction;
                ...
                speed = 7;
                time += 10;
                if ( time < 500 ) { mark_ctrl = true; speed = 7;}
                else if(time < 800) {mark_ctrl = false; speed = 5;}
                if ( time > 800) { time = 0;}
        ...
        if(counter1 % 6 == 0 && mark_ctrl == false && mark_r == false &&  mark_l == false && suspection == true && mark_ctrl == false) {
            static int  counter_suspection_left = 0;
            ...
            else if(counter1 % 6 == 0 && mark_l == false && mark_r == false && turn_right == true && suspection == false && mark_ctrl == false) {
            ...
            else if(counter1 % 6 == 0 && mark_l == false && mark_r == false && turn_left == true && suspection == false) {
                ...
                else if(counter1 % 6 == 0 && mark_l == true && mark_r == false && suspection == false && mark_ctrl == false) {
                static int counter_enemy_left_walk = 0;
                    ...
                    else if(counter1 % 6 == 0 && mark_l == false && mark == true && mark_r == true && suspection == false && mark_ctrl == false) {
                static int counter_enemy_right_walk = 0;
                    ...
                    else if(counter1 % 6 == 0 && mark_l == true && mark == true && mark_r == false && suspection == false && mark_ctrl == true) {
                ...
                switch(counter_enemy_left_fight % 7) {
                  ...
                  case 6:
                    ...
                    else if(counter1 % 6 == 0 && mark_l == false && mark == true && mark_r == true && suspection == false && mark_ctrl == true) {
                 ...
                 mark = true;
                    ...
                    if(counter1 % 6 == 0 && mark_r == true && mark_l == false && mark == true) {
                        static int counter_enemy_right_walk = 0;
                                   switch(counter_enemy_right_walk % 9) {
                                     case 0:
                                       setPixmap(QPixmap(":/new/enemy_right_walk/F:/Qt/Poroje/SPRITE/ENEMY/walk/Right/1.png"));
                    ...
                    else if(mark_r == false && mark == true && mark_l == true && mark_ctrl == false && counter1 % 6 == 0) {
                        static int counter_enemy_left_walk = 0;
                                   switch(counter_enemy_left_walk % 9) {
                                     case 0:
                                        setPixmap(QPixmap(":/new/enemy_left_walk/F:/Qt/Poroje/SPRITE/ENEMY/walk/Left/1.png"));
